...
export default function  () {
    ...
    let getUser = async ()=>{
        let res = await axios.get('https://threatesbackend.onrender.com/users/getUser',{
            headers:{
    ...
    const updateHandler = async()=>{
      ...
      let res = await fetch(`https://threatesbackend.onrender.com/users/update/`,{
        method:"PUT",
        headers:{
      ...
      >
        ...
        <CardContent>
          ...
          >
            ...
            <button onClick={updateHandler} className='btn btn-dark'>Update Details</button>
          </Sheet>
